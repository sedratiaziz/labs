...
isAdultPresent = devs.some((element) => {
...
isEveryone19OrOlder = devs.every((element) => {
  return element.year >= 2005;
});
// Complete the exercise in the space below:
...
let commentById = {};
commentById = comments.find((element) => {
...
let idx = null;
idx = comments.findIndex((element) => {
  return element.id === 123523;
});
// Complete the exercise in the space below:
