...
const userProfile = {
    [propertyName] : 'abdulaziz@gmail.com',
}
...
/*  THIS EXCERCISE IS DONE ON THESE FILES: */
//  - importingFile.js  
//  - exportingFile.js 
...
const makeSentence = (noun = 'cat', adj = 'orange')=> {
...
// unDefault behaviour             ('unDefault', what an english lol) 
makeSentence("dog", "blue")
...
let tasteCheck = (pizza === "tasty") ? "yum" : "yuck"

console.log(tasteCheck)
...
// other approach:
// let lang = localLangConfig ? localLangConfig : 'en'
...
// other approach
// let theme = savedUserTheme ? savedUserTheme : 'light'
